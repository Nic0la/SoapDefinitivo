 ...
 * 
 */
@WebServiceClient(name = "RandServiceService", targetNamespace = "http://rand/", wsdlLocation = "http://localhost:8080/RandService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/RandService?wsdl");
