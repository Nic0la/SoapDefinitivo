 ...
 * generated in the src.main.java.server package. 
...
public class ObjectFactory {
    ...
    private final static QName _NextNResponse_QNAME = new QName("http://nextnresp.rand/", "nextNResponse");
    private final static QName _Next1Response_QNAME = new QName("http://next1resp.rand/", "next1Response");
    private final static QName _NextN_QNAME = new QName("http://nextn.rand/", "nextN");
    private final static QName _Next1_QNAME = new QName("http://next1rand/", "next1");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: src.main.java.server
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nextnresp.rand/", name = "nextNResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://next1resp.rand/", name = "next1Response")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://nextn.rand/", name = "nextN")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://next1rand/", name = "next1")
